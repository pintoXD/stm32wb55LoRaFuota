...
#define SE_CALLGATE_REGION_ROM_END          (SE_CODE_REGION_ROM_START + 0x2FF) //1FF
...
/* For FreeRTOS integration (IT_MANAGEMENT switch activated ):
 * ========================================================== 
 *    - add 0x10 to force __ICFEDIT_SE_IF_region_ROM_start__ bit[4] to 1 for FWALL IRQ mgmt
 *    - this is required for PendSV handler (FPU register save/restore mechanism)
 *    ==> #define SE_IF_REGION_ROM_START    ((SE_CODE_REGION_ROM_END + 0x1) | 0x10) 
 */
...
#define SB_REGION_ROM_END                   0x08014FFF
