...
@par Directory contents
   ...
   - 1_Image_SECoreBin/Src/hw_ipcc.c                           Hardware IPCC source file for BLE
   - 1_Image_SECoreBin/Src/se_cm0.c                            Secure Engine communication with CM0
   ...
   - 1_Image_SECoreBin/Src/stm32wbxx_hal_msp.c                 HAL MSP implementation
   - 1_Image_SECoreBin/Src/stm32wbxx_it.c                      Interrupt handler
   - 1_Image_SECoreBin/Inc/app_common.h                        App Common application configuration file for BLE
   - 1_Image_SECoreBin/Inc/app_conf.h                          Application configuration file for BLE
   - 1_Image_SECoreBin/Inc/hw_conf.h                           Hardware configuration file for BLE
   - 1_Image_SECoreBin/Inc/hw_if.h                             Hardware Interface for BLE
   - 1_Image_SECoreBin/Inc/se_cm0.h                            Definitions for CM0 operations
   ...
   - 1_Image_SECoreBin/Inc/stm32wbxx_it.h                      Header file for Interrupt handler
   - 1_Image_SECoreBin/Inc/utilities_conf.h                    Configuration file for utilities
