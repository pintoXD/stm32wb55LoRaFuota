...
This examples is provided with a single firmware image configuration in order to maximize firmware image size. As a 
consequence, resume firmware update is not possible in case of power off during installations.

It can be configured to use asymmetric or symmetric cryptographic schemes with or without firmware encryption.
...
provisioned. Please refer to SE_CoreBin readme.txt for the procedure.
