...
/**
  ...
  */
#define APP_PROTECT_MPU_AREA_ACTIVE_SLOT_START  FLASH_BASE                   /*!< Flash memory area */
...
#define APP_PROTECT_MPU_AREA_ACTIVE_SLOT_SREG   0x03U                        /*!< 256 Kbytes / 8 * 6 ==> 192 Kbytes */
