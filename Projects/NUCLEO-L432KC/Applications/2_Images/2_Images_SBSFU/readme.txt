...
@par Hardware and Software environment
   ...
   - This example has been tested with STM32L432KC-Nucleo RevC board and can be easily tailored to any other supported device and
     development board.
...
Note1 : Remove the jumper between PA.12 (Arduino D2) and GND to force a local download at
