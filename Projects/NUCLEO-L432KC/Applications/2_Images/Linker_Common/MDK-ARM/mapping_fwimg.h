...
/* swap  (4 kbytes) */
#define SWAP_START                   0x0800F000
#define SWAP_END                     0x0800FFFF

/* Active slot #1  (96 kbytes) */
#define SLOT_ACTIVE_1_START          0x08010000
#define SLOT_ACTIVE_1_END            0x08027FFF
#define SLOT_ACTIVE_1_HEADER         SLOT_ACTIVE_1_START

/* Dwl slot #1  (96 kbytes) */
#define SLOT_DWL_1_START             0x08028000
#define SLOT_DWL_1_END               0x0803FFFF
