...
@par Hardware and Software environment
   ...
   - This example has been tested with STM32L152RE-Nucleo Rev C board and can be easily tailored to any other supported device and
     development board.
...
2. Pressing 2 allows to test protections.
   ...
   - TAMPER test (#7): causes a reset if a tamper event is detected. In order to generate a tamper event, user has to
     connect PA0 (CN8.1) to GND (It may be enough to put your finger close to PA0 (CN8.1)).
