...
/**
  * @brief Region 0 - Enable the read/write operations for full (except AES, FSMC) peripheral area (without bit banding
...
#define SFU_PROTECT_MPU_PERIPH_2_START RCC_BASE           /*!< RCC peripheral memory area */
