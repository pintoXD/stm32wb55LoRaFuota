...
/* swap  (4 kbytes) */
#define SWAP_START                   0x08070000
#define SWAP_END                     0x08070FFF

/* Active slot #1  (192 kbytes) */
#define SLOT_ACTIVE_1_START          0x08010000
#define SLOT_ACTIVE_1_END            0x0803FFFF
#define SLOT_ACTIVE_1_HEADER         SLOT_ACTIVE_1_START

/* Dwl slot #1  (192 kbytes) */
#define SLOT_DWL_1_START             0x08040000
#define SLOT_DWL_1_END               0x0806FFFF
