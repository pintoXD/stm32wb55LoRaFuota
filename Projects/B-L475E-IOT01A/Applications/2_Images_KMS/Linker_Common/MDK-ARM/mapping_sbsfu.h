...
#define SE_CODE_REGION_ROM_END              (SE_STARTUP_REGION_ROM_START + 0xE7FF)
...
#define SE_IF_REGION_ROM_END                (SE_IF_REGION_ROM_START + 0xFFF)

/* SBSFU Code region */
#define SB_REGION_ROM_START                 (SE_IF_REGION_ROM_END + 0x1)
#define SB_REGION_ROM_END                   0x08019FFF
...
#define SE_REGION_RAM_STACK_TOP           0x20000600
#define SE_REGION_RAM_END                 0x20002BFF
