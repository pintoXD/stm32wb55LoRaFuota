...
const kms_obj_keyhead_256_t Test_Key_RSA_2048 __attribute__((section(".KMS_blob_Keys"))) =
#else
...
#if defined (__GNUC__) || defined(__ARMCC_VERSION)
const kms_obj_keyhead_64_t Test_Key_AES256_Derivable __attribute__((section(".KMS_blob_Keys"))) =
#else
const kms_obj_keyhead_64_t Test_Key_AES256_Derivable =
#endif /* __GNUC__ || __ARMCC_VERSION */
{
  KMS_ABI_VERSION_CK_2_40,                /*   uint32_t version;           */
  KMS_ABI_CONFIG_KEYHEAD,                 /*   uint32_t configuration;     */
