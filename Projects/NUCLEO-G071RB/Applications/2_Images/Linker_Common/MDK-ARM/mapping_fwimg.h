...
/* swap  (4 kbytes) */
#define SWAP_START                   0x08017000
#define SWAP_END                     0x08017FFF

/* Active slot #1  (28 kbytes) */
#define SLOT_ACTIVE_1_START          0x08010000
#define SLOT_ACTIVE_1_END            0x08016FFF
#define SLOT_ACTIVE_1_HEADER         SLOT_ACTIVE_1_START

/* Dwl slot #1  (28 kbytes) */
#define SLOT_DWL_1_START             0x08018000
#define SLOT_DWL_1_END               0x0801EFFF
