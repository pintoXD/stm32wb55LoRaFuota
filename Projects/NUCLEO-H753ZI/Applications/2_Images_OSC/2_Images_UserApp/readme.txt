...
@par Hardware and Software environment
   ...
   - This example has been tested with STM32H753ZI-Nucleo board and can be easily tailored to any other supported device and
     development board.
...
2. Pressing 2 allows to test protections.
   ...
   - TAMPER test (#4): causes a reset if a tamper event is detected. In order to generate a tamper event, user has to
     connect PC1 (CN11.36) to GND (It may be enough to put your finger close to PC1 (CN11.36)).
