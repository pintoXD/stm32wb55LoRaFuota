...
One cryptographic scheme (SECBOOT_ECCDSA_WITH_AES128_CTR_SHA256) is provided as example to illustrate the cryptographic
operations. This cryptographic scheme uses AES CTR encryption and asymmetric (ECDSA) cryptography. OTFDEC IP (On The Fly
Decryption) is configured to execute the encrypted (AES CTR) user application from external flash.
...
@par Directory contents
   ...
   - 2_Images_SECoreBin/Binary/OEM_KEY_COMPANY1_key_AES_CTR.bin Public key for AES CTR encryption
