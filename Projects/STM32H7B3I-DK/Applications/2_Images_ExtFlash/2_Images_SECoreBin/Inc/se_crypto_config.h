...
/**
  ...
  *
  * SECBOOT_ECCDSA_WITH_AES128_CTR_SHA256: Authentication, Integrity, Confidentiality are ensured.
  *                           Authenticate Firmware Metadata using SHA256 signed with ECC DSA.
  *                           Decrypt Firmware Image with OTFDEC (AES128-CTR)
  *                           Firmware Image Integrity using SHA256 on encrypted Firmware (SHA256 stored in the
  *                           authenticated metadata).
  */
#define SECBOOT_CRYPTO_SCHEME SECBOOT_ECCDSA_WITH_AES128_CTR_SHA256 /*!< Selected Crypto Scheme */

#define SECBOOT_ECCDSA_WITH_AES128_CTR_SHA256        (5U) /*!< asymmetric crypto with encrypted Firmware     */
/**
  * @}
  */
