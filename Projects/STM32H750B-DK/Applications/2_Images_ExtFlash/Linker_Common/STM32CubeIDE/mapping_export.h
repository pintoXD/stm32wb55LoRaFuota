...
extern uint32_t __ICFEDIT_APP_LOADER_region_ROM_start__ ;
#define APP_LOADER_REGION_ROM_START ((uint32_t)& __ICFEDIT_APP_LOADER_region_ROM_start__)
extern uint32_t __ICFEDIT_APP_LOADER_region_ROM_end__ ;
#define APP_LOADER_REGION_ROM_END ((uint32_t)& __ICFEDIT_APP_LOADER_region_ROM_end__)
extern uint32_t __ICFEDIT_APP_LOADER_region_RAM_code_start__ ;
#define APP_LOADER_REGION_RAM_CODE_START ((uint32_t)& __ICFEDIT_APP_LOADER_region_RAM_code_start__)
extern uint32_t __ICFEDIT_APP_LOADER_region_RAM_code_end__ ;
#define APP_LOADER_REGION_RAM_CODE_END ((uint32_t)& __ICFEDIT_APP_LOADER_region_RAM_code_end__)
extern uint32_t __ICFEDIT_SECURE_COUNTER_region_ROM_start__;
#define SECURE_COUNTER_REGION_ROM_START ((uint32_t)& __ICFEDIT_SECURE_COUNTER_region_ROM_start__)
extern uint32_t __ICFEDIT_SECURE_COUNTER_region_ROM_end__;
#define SECURE_COUNTER_REGION_ROM_END ((uint32_t)& __ICFEDIT_SECURE_COUNTER_region_ROM_end__)
