...
@par Directory contents
   ...
   - 2_Images_SBSFU/Inc/stm32h750b_discovery_conf.h  BSP configuration file
...
In this example, the user application relies on standalone loader project for the download functionality.
...
2. Pressing 2 allows to test protections.
   ...
   - TAMPER test (#4): TAMPER protection is not activated on this board due to conflict with USER button.
...
Note3 : The secure user memory protection is activated only if SFU_FINAL_SECURE_LOCK_ENABLE is defined in app_sfu.h
        from SBSFU project.
