...
#define COM_UART_TX_PIN                         GPIO_PIN_10
...
#define COM_UART_RX_GPIO_PORT                   GPIOB
#define COM_UART_RX_PIN                         GPIO_PIN_11
#define COM_UART_RX_GPIO_CLK_ENABLE()           __HAL_RCC_GPIOB_CLK_ENABLE()
#define COM_UART_RX_GPIO_CLK_DISABLE()          __HAL_RCC_GPIOB_CLK_DISABLE()
