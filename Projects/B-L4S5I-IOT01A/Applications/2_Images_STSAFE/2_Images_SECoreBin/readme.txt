...
It has to be compiled before SBSFU project and requires the execution of STSAFE Provisioning project for data
provisioning and device pairing.

One cryptographic scheme (SECBOOT_X509_ECDSA_WITHOUT_ENCRYPT_SHA256) is provided as example to illustrate the
cryptographic operations. This cryptographic scheme uses Certificates (X509) and asymmetric (ECDSA) cryptography.
...
@par Directory contents
   ...
   - 2_Images_SECoreBin/Inc/stsafe_platf_objects_config.h       Header file for STSAFE-A1xx platform objects embedded objects definitions
...
This preliminary processing is in charge of:
   ...
   - generating the appropriate keys in <IDE folder>/kms_platf_objects_config.h (from injection of Blob importation
