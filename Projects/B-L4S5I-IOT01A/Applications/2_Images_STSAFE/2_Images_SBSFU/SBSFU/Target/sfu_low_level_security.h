...
#define SFU_PROTECT_FWALL_CODE_SIZE         ((uint32_t) SFU_SENG_ROM_SIZE)       /*!< Firewall protection CODE area
                                                                                      SIZE*/
#define SFU_PROTECT_FWALL_NVDATA_ADDR_START (KMS_DATASTORAGE_START)               /*!< Firewall protection NVDATA area
                                                                                      START address*/
...
/**
  ...
  */
/**
  * Region definition : from 0x0812 0000 ==> 0x081F FFFF
  */
#define APP_PROTECT_MPU_AREA_ACTIVE_SLOT_START  (SLOT_ACTIVE_1_START / 0x100000 * 0x100000)
...
#define APP_PROTECT_MPU_AREA_ACTIVE_SLOT_SREG   0x01U                        /*!< Keep first 128K unchanged */
