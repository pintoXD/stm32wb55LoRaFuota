...
It also demonstrate key management services through basic examples and specific boot mechanism (secure firmware
update decryption, verification...)
...
With ENABLE_IMAGE_STATE_HANDLING compilation switch activated, each new firmware image should be validated at first
